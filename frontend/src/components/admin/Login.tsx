...
export const Login = ({ season = 'summer', onSeasonToggle = () => {} }: LoginProps) => {
  ...
  // Enforce laptop/desktop screens only
  useEffect(() => {
  ...
  // Block small screens entirely, render only the message
  if (!isLaptop) {
    const backgroundGradient = season === 'summer' 
      ? 'from-green-50 via-emerald-50 to-teal-50'
      : 'from-blue-50 via-slate-50 to-indigo-50';
    return (
      <div className={`min-h-screen bg-gradient-to-br ${backgroundGradient} flex items-center justify-center p-6`}>
